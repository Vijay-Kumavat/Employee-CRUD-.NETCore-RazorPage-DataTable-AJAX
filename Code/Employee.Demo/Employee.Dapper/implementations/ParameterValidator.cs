...
namespace Employee.Dapper.implementations
{
    public static class ParameterValidator
    {
        ...
        public static void ValidateEnumerable(IEnumerable enumerable, string nameParameter, string customMessage = null)
        {
            ...
            if (nullItems.Any())
                throw new ArgumentNullException(nameParameter, customMessage ?? $"The colec-parameter {nameParameter} has not any null item");
        }
        ...
        public static void ValidateEnumerableString(IEnumerable<string> enumerable, string nameParameter, string customMessage = null)
        {
            ...
            if (nullItems.Any())
                throw new ArgumentNullException(nameParameter, customMessage ?? $"The colec-parameter {nameParameter} has not any null/empty/white item");
        }
